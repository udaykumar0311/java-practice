...
//        priorityQueueNaturalOrdering();
    ...
    public static void priorityQueueNaturalOrdering(){
        ...
        Queue<Double> doubleNumbers = new PriorityQueue<>();// numeric ordering
        doubleNumbers.add(2.3);
        doubleNumbers.add(1.4);
        doubleNumbers.add(2.6);
        Iterator itDoubleNumbers = doubleNumbers.iterator();
        while(itDoubleNumbers.hasNext()){
            System.out.print(doubleNumbers.poll() + " "); // 2 5 11
        }
    }
